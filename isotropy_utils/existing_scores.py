'''
This code comes from the implementation code repository of IsoScore.
'''
...
from isotropy_utils.helper_functions import pca_normalization
...
def partition_score(points): # This actually has errors, so I do not use it
