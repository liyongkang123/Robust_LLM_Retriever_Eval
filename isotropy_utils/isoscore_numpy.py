# -*- coding: utf-8 -*-
'''
This is the original version  from the implementation code repository of IsoScore, implemented using NumPy.
The input points is a NumPy array of size (dim, num_docs).
The output IsoScore is a scalar.
'''
...
def pca_normalization(points):
    ...
    pca = PCA(n_components=len(np.transpose(points))) # n_components is the dim
